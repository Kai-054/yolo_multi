...
from ultralytics.yolo.utils.metrics import DetMetrics, AverageMeter
...
class BaseValidator:
    ...
    def __call__(self, trainer=None, model=None):
        ...
        """
        self.training = trainer is not None # Xác định xem có đang trong quá trình huấn luyện hay không
        if self.training:
